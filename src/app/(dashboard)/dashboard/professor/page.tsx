    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">프로젝트를 관리하고 학생들의 진행 상황을 확인하세요</p>
        </div>
      ...
      {projects.length === 0 ? (
        <div className="card p-8 text-center">
          ...
          <h3 className="text-sm font-semibold text-slate-900 mb-1">아직 프로젝트가 없습니다</h3>
          <p className="text-sm text-slate-500 mb-4">첫 프로젝트를 만들어 학생들과 시작해보세요</p>
          <Link href="/projects/create" className="btn-primary text-sm">
            새 프로젝트 만들기
          </Link>
        </div>
          ...
          {projects.map((project) => {
            ...
            return (
              ...
              >
                ...
                {/* Join Code */}
                <div
                  className="flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 mb-3"
                  onClick={(e) => {
                    e.preventDefault();
                ...
                >
                  ...
                  <code className="text-sm font-mono font-semibold text-slate-900 tracking-wider flex-1">
                    {project.joinCode}
                  </code>
